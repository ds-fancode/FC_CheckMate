import { loader } from "~/routes/api/v1/platform"; // Adjust the path as necessary
...
describe("Get Platforms - Loader Function", () => {
  ...
  it("should successfully fetch platform data for a valid orgId", async () => {
    ...
    (PlatformController.getAllPlatform as jest.Mock).mockResolvedValue(mockPlatformData);
