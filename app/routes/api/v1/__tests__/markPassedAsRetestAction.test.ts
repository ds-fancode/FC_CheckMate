import { action } from "~/routes/api/v1/markPassedAsRetest"; // Adjust the path as necessary
...
describe("Mark Passed as Retest - Action Function", () => {
  ...
  it("should successfully mark passed tests as retest", async () => {
    ...
    (TestRunsController.markPassedAsRetest as jest.Mock).mockResolvedValue(mockResponseData);
