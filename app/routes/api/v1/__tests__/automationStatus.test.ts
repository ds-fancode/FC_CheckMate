import {loader} from '~/routes/api/v1/automationStatus'
...
describe('Automation Status Loader', () => {
  ...
  it('should return automation status data when orgId is valid', async () => {
    ...
    ;(
      AutomationStatusController.getAllAutomationStatus as jest.Mock
    ).mockResolvedValue(mockAutomationStatusData)
    ...
    expect(
      AutomationStatusController.getAllAutomationStatus,
