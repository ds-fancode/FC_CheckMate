import { loader } from "~/routes/api/v1/runTestsList"; // Adjust the path as necessary
...
describe("Get Run Tests - Loader Function", () => {
  ...
  it("should successfully fetch test runs data for valid search parameters", async () => {
    ...
    (TestRunsController.getAllTestRuns as jest.Mock).mockResolvedValue(mockTestRunsData);
    ...
    expect(TestRunsController.getAllTestRuns).toHaveBeenCalledWith(mockSearchParams);
