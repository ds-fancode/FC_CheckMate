import { loader } from "~/routes/api/v1/getAllUser"; // Adjust the path as necessary
...
describe("Get All Users - Loader Function", () => {
  ...
  it("should return all users and their count when request is valid", async () => {
    ...
    const mockUserData = [
      ...
      { userId: 2, userName: "Jane Smith", email: "jane@example.com", role: "Admin" },
    ];
    ...
    (UsersController.getUsersCount as jest.Mock).mockResolvedValue(mockUsersCount);
