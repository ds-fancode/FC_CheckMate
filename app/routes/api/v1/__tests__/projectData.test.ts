import { loader } from "~/routes/api/v1/projectData"; // Adjust the path as necessary
...
describe("Get Project Detail - Loader Function", () => {
  ...
  it("should successfully fetch project details for a valid projectId", async () => {
    ...
    (ProjectsController.getProjectInfo as jest.Mock).mockResolvedValue(mockProjectData);
