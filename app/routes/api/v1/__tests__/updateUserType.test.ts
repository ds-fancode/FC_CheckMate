import { action } from "~/routes/api/v1/updateUserType"; // Adjust the path as necessary
...
describe("Update User Role - Action Function", () => {
  ...
  it("should successfully update a user's role for valid input", async () => {
    ...
    (UsersController.updateUserRole as jest.Mock).mockResolvedValue(mockResponse);
