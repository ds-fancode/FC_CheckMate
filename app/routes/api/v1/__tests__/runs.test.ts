import {loader} from '~/routes/api/v1/runs'
...
describe('Get Runs - Loader Function', () => {
  ...
  it('should successfully fetch runs for a valid projectId', async () => {
    const request = new Request(
      'http://localhost?projectId=123&page=1&pageSize=10&search=test',
      {
        method: 'GET',
      },
    )
  ...
  it('should return an error if projectId is missing', async () => {
    const request = new Request('http://localhost?page=1&pageSize=10', {
      method: 'GET',
    })
  ...
  it('should handle unexpected errors', async () => {
    const request = new Request(
      'http://localhost?projectId=123&page=1&pageSize=10',
      {
        method: 'GET',
      },
    )
