import UsersController, { IUpdateUserRole } from "@controllers/users.controller"; // Adjust the path as necessary
...
describe("UsersController", () => {
  ...
  describe("updateUserRole", () => {
    it("should call UsersDao.updateUserRole with the correct parameters", async () => {
      const mockParams:IUpdateUserRole = { userId: 1, newRole: "admin", updatedBy: 2 };
      const mockResponse = { success: true };
