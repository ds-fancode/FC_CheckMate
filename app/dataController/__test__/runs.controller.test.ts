...
import RunsController, { ICreateRuns, IGetAllRuns, IUpdateRun } from "@controllers/runs.controller"; // Adjust the path as necessary
...
describe("RunsController", () => {
  ...
  describe("getAllRuns", () => {
    ...
    it("should handle errors from RunsDao.getAllRuns", async () => {
      ...
      await expect(RunsController.getAllRuns(mockParams)).rejects.toThrow("Database error");
  ...
  describe("createRun", () => {
    ...
    it("should handle errors from RunsDao.createRun", async () => {
      ...
      await expect(RunsController.createRun(mockParams)).rejects.toThrow("Database error");
  ...
  describe("getRunInfo", () => {
    ...
    it("should handle errors from RunsDao.getRunInfo", async () => {
      ...
      await expect(RunsController.getRunInfo(mockParams)).rejects.toThrow("Database error");
  ...
  describe("deleteRun", () => {
    ...
    it("should handle errors from RunsDao.deleteRun", async () => {
      ...
      await expect(RunsController.deleteRun(mockParams)).rejects.toThrow("Database error");
  ...
  describe("lockRun", () => {
    ...
    it("should handle errors from RunsDao.lockRun", async () => {
      ...
      await expect(RunsController.lockRun(mockParams)).rejects.toThrow("Database error");
  ...
  describe("updateRun", () => {
    ...
    it("should handle errors from RunsDao.updateRun", async () => {
      ...
      await expect(RunsController.updateRun(mockParams)).rejects.toThrow("Database error");
