import SquadsController from "@controllers/squads.controller"; // Adjust the path as necessary
...
describe("SquadsController", () => {
  ...
  describe("addSquad", () => {
    it("should call SquadsDao.addSquad with the correct parameters", async () => {
      const mockParams = { squadName: "New Squad", projectId: 123, createdBy: 456 };
      const mockResponse = { squadId: 1 };
  ...
  describe("checkAndCreateSquad", () => {
    it("should return an existing squad if found", async () => {
      const mockParams = { squadName: "Existing Squad", projectId: 123, createdBy: 456 };
      const mockResponse = [{ squadId: 1 }];
